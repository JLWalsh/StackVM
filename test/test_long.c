...
{
    before_each();
    stack_push(&vm.stack, stack_object_of_long(10));
    stack_push(&vm.stack, stack_object_of_long(25));
...
{
    before_each();
    stack_push(&vm.stack, stack_object_of_long(45648));
    stack_push(&vm.stack, stack_object_of_long(564864));
...
{
    before_each();
    stack_push(&vm.stack, stack_object_of_long(5));
    stack_push(&vm.stack, stack_object_of_long(10));
...
{
    before_each();
    stack_push(&vm.stack, stack_object_of_long(512));
    stack_push(&vm.stack, stack_object_of_long(10));
...
{
    before_each();
    stack_push(&vm.stack, stack_object_of_long(6));
    stack_push(&vm.stack, stack_object_of_long(32));
...
{
    before_each();
    stack_push(&vm.stack, stack_object_of_long(14));
    stack_push(&vm.stack, stack_object_of_long(27));
...
{
    before_each();
    stack_push(&vm.stack, stack_object_of_long(480));
...
{
    before_each();
    stack_push(&vm.stack, stack_object_of_long(2));
    stack_push(&vm.stack, stack_object_of_long(15));
...
{
    before_each();
    stack_push(&vm.stack, stack_object_of_ulong(10));
    stack_push(&vm.stack, stack_object_of_ulong(25));
...
{
    before_each();
    stack_push(&vm.stack, stack_object_of_ulong(45648));
    stack_push(&vm.stack, stack_object_of_ulong(564864));
...
{
    before_each();
    stack_push(&vm.stack, stack_object_of_ulong(5));
    stack_push(&vm.stack, stack_object_of_ulong(10));
...
{
    before_each();
    stack_push(&vm.stack, stack_object_of_ulong(512));
    stack_push(&vm.stack, stack_object_of_ulong(10));
...
{
    before_each();
    stack_push(&vm.stack, stack_object_of_ulong(6));
    stack_push(&vm.stack, stack_object_of_ulong(32));
...
{
    before_each();
    stack_push(&vm.stack, stack_object_of_ulong(14));
    stack_push(&vm.stack, stack_object_of_ulong(27));
...
{
    before_each();
    stack_push(&vm.stack, stack_object_of_ulong(480));
...
{
    before_each();
    stack_push(&vm.stack, stack_object_of_ulong(2));
    stack_push(&vm.stack, stack_object_of_ulong(15));
