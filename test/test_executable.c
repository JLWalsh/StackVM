...
{
    char executable[] = {
        0, 0, 0, 0, 0, 0, 12, // Executable length
        0, 0, 0, 0, 0, 0, 0, // Constants length
        0 // Program
    };
...
void test_executable_header_should_parse_constants_length()
{
    char executable[] = {
        0, 0, 0, 0, 0, 0, 12, // Executable length
        0, 0, 0, 0, 0, 0, 241, // Constants length
        0 // Program
    };
    STREAM s = stream_create(&executable);
...
{
    char executable[] = {
        0, 0, 0, 0, 0, 0, 21, // Executable length
        0, 0, 0, 0, 0, 0, 4, // Constants length
        1, 2, 3, 4, // Constants
        0 // Program
    };

    EXECUTABLE parsed_executable = executable_from(&executable);
    char*      parsed_constants  = (char*)parsed_executable.constants.data;
    ...
    TEST_ASSERT_EQUAL_UINT64(parsed_executable.constants.length, 4);
...
{
    char executable[] = {
        0, 0, 0, 0, 0, 0, 20, // Executable length
        0, 0, 0, 0, 0, 0, 0, // Constants length
        10, 20, 30, 40 // Program
    };
